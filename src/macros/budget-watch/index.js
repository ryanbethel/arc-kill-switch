...
module.exports = function costDetection (arc, cfn) {
  ...
  if (guard) {
    ...
    // so we use a tag with the GetAtt to create inherent dependancy
    ...
    // This lambda is used to reset the concurrency of lambdas if the budget is updated
    ...
    // be stalled for up to an hour until it times out.
